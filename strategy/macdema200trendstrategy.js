...
class MacdEma200TrendStrategy extends TradeStrategy {
        ...
        if(lastMACD.macd > lastMACD.signal) {
            ...
            if(beforeLastMACD.macd < beforeLastMACD.signal) {
                ...
                if(lastKline.close > lastEma2000 && lastKline.open > lastEma2000) {
                    ...
                    if(lastEma2000/last100Ema2000 > 1.02) {
        ...
        if(lastMACD.macd < lastMACD.signal) {
            ...
            if(beforeLastMACD.macd > beforeLastMACD.signal) {
                ...
                if(lastKline.close < lastEma2000 && lastKline.open < lastEma2000) {
                    ...
                    if(lastEma2000/last100Ema2000 < 0.98) {
                        if(lastMACD.macd > 0 && lastMACD.signal > 0) {
                            // open short
...
module.exports = MacdEma200TrendStrategy;